...
!function() {
        ...
        return new Proxy(obj, {
            get(target, p, receiver) {
                ...
                if(typeof val === 'function') {
                    console.log('proxy_get: ', name, '.', p, ' => function');
                }
                else {
                    console.log('proxy_get: ', name, '.', p, ' =>', val);
                }
                return val;
            },
            set(target, p, value, receiver) {
                ...
                if(typeof val === 'function' && typeof value === 'function') {
                    console.log('proxy_set: ', name, '.', p, '= function <== function');
                }
                else if(typeof val === 'functon') {
                    console.log('proxy_set: ', name, '.', p, '=', value, '<== function');
                }
                else if(typeof value === 'fucntion') {
                    console.log('proxy_set: ', name, '.', p, '= function <==', val);
                }
                else {
                    console.log('proxy_set: ', name, '.', p, '=', value, '<==', val);
                }
    ...
    set_native = function set_native(func, key, value) {
    ...
    !(function () {
        Function.prototype.toString_ = Function.toString;
        const myFunction_toString_symbol = Symbol('(HD 236300)_' + Math.random());
        // 重写的 toString 方法，如果 this 拥有 myFunction_toString_symbol 属性，则返回 native code
        const toString = function toString() {
            return typeof this == 'function' && this[myFunction_toString_symbol] || this.toString_();
        }
        ...
        func_set_native(Function.prototype.toString);
        // 删除 toString 的原型
    ...
    Object.prototype.toString = function toString() {
        // debugger;
        return obj_to_str.call(this, ...arguments);
    };
    func_set_native(Object.prototype.toString);

    let func_to_str = Function.prototype.toString;
    Function.prototype.toString = function toString() {
        // debugger;
        return func_to_str.call(this, ...arguments);
    };
    ...
    Object.getOwnPropertyDescriptor = function(obj, attr) {
        debugger;
        return getOwnPropertyDescriptor(obj, attr);
    };

    let getOwnPropertyDescriptors = Object.getOwnPropertyDescriptors;
    Object.getOwnPropertyDescriptors = function(obj) {
        debugger;
        return getOwnPropertyDescriptors(obj);
    };

    let hasOwn = Object.hasOwn;
    Object.hasOwn = function(obj) {
        debugger;
        return hasOwn(obj);
    };
    ...
    my_instanceof = function(left, right) {
        debugger;
...
window = globalThis;
set_toString(window, 'Window');
document = {
    cookie: '_ga=GA1.1.56998333.1754873898; local_city_cache=%E7%A6%8F%E5%B7%9E; x-web-secsdk-uid=b51dc976-ccba-4ac8-ad80-2ae8a713d7f3; csrftoken=497af9b4a147fc99aeedb45d118c926c; s_v_web_id=verify_me6ely7x_pKW4ZvNA_pCCS_47lD_AFgn_LI6Os4eQfYUI; gfkadpd=24,6457; ttcid=7c3e554d04db484e9ed5dbc6ccc661cb30; _ga_QEHZPBE5HH=GS2.1.s1754878134$o2$g1$t1713631758$j60$l0$h0',
    referrer: 'https://www.toutiao.com/',
    createElement: function(tag_name) {
        let toDataURL = function toDataURL() {return 'data:image/png;base64,'};
        func_set_native(toDataURL);
        return watch({
            toDataURL: toDataURL,
            getContext: function(context) {
                if(context === '2d') {
                    return watch({
                        ...
                        arc: function() {},
                        stroke: function() {}
                    }, `document.createElement("${tag_name}").getContext("${context}")`);
                }
                    ...
                    return watch({
                        getExtension: function(arg) {
                            ...
                            if(arg === 'WEBGL_debug_renderer_info') {
                                ...
                                }, `document.createElement("${tag_name}").getContext("${context}").getExtension("${arg}")`);
                            }
                        },
...
sessionStorage = {
    _byted_param_sw: 'kMQW19b8BqqGiY+1ka0=',
    tt_scid: '8SFf73tjtXDaX.5QuORj2PYfqSxUf54VMW..jJ2K2JLcv1TYEnRwRrd.6b-o0JtJcb8f',
...
item = function (index) {
    if (index == 0) {
        return watch({type: 'application/pdf'}, 'navigator.plugins[0].item(0)');
    } else if (index == 1) {
        return watch({type: 'text/pdf'}, 'navigator.plugins[0].item(1)');
    }
    return null;
}
plugins = watch({
...
set_toString(plugins, 'PluginArray');
navigator = {
...
location = {
    "ancestorOrigins": {},
    "href": "https://www.toutiao.com/?wid=1754873921183",
...
(glb = "undefined" == typeof window ? global : window)._$jsvmprt = function(b, e, f) {
    ...
    function n(b) {
        return function(b) {
            ...
            if (my_in(Symbol.iterator, Object(b)) || "[object Arguments]" === Object.prototype.toString.call(b))
                return Array.from(b)
        }(b) || function() {
                ...
                A < 1) {
                    ...
                    A > 2)
                        ...
                        if ((A = x) < 2) {
                            ...
                            A < 6 ? (C = S[R--],
                            S[R] = S[R] % C) : A < 8 ? (C = S[R--],
                            S[R] = my_instanceof(S[R], C)) : A < 15 && (S[++R] = !1)
                    } else if (A > 0) {
...
log(window.byted_acrawler.sign.call(byted_acrawler, {url: 'https://www.toutiao.com/hot-event/hot-board/?origin=toutiao_pc'}));
