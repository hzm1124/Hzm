...
function b(t, n) {
    ...
    var lennon = '';
    for (let i of r) {
        lennon += (i).toString(16).padStart(2, '0');
    }
    return lennon;
}
...
var n = '{"keyWords":"","drugType":"","pageNo":3,"pageSize":10,"medListCodg":"X"}';
var appCode = 'T98HPCGN5ZVVQBS8LZQNOAEXVI9GYHKQ';
var appSecret = 'NMVFVILMKT13GEMD3BKPKCTBOQBPZR2P';
console.log(get_enc_data(n, appCode, appSecret));

function decrypt(n, e, t) {
    t = y(e, t);
    var i = encrypt(n, t, 0), r = i[i.length - 1];
